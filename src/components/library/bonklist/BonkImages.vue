<template>
  <b-modal ref="selectModal" scrollable size="xl">
    <template #modal-header="{ close }">
      <h5 class="modal-title">Select Items for Bonk</h5>
      ...
      <div v-if="itemList" :key="listKey">
        <div id="bonkImagesCustom" class="row">
          <div id="imageTableCustom" class="imageTable col-12">
            ...
            <div v-for="(item, key) in itemList" id="imageRowCustom" class="row imageRow" :key="'bi_'+item.id+listKey">
              <div class="imageRowInner">
                ...
                <img class="imageImage" :src="'file://'+getItemPath(item.location)"></img>
